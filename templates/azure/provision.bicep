...
module botProvision './provision/botService.bicep' = {
  ...
  params: {
    ...
    msiClientId: userAssignedIdentityProvision.outputs.identityClientId
    msiResourceId: userAssignedIdentityProvision.outputs.identityResourceId
    msiTenantId: userAssignedIdentityProvision.outputs.identityTenantId
  }
}
